...
if ($#argv == 2) then
  ...
  echo "\nUsage : $0:t <Version Number> <Properties_file_name> <force - not mandatory> \n "
  echo "e.g. : $0:t 702 CRM_810.roperties force"
  echo "force oprion requires $HOME/bin/ccQueries.pl"
  exit 1
endif
